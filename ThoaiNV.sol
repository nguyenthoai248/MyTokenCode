...
contract GunBet is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GUNBET2";
    string private constant _symbol = unicode"GUNBET2";
    ...
    constructor () {
        ...
        _safu = _msgSender();
		_revshareWallet = payable(address(0xC8893f7b271baBd8EF8A2dd91916DbBfB825483F));
